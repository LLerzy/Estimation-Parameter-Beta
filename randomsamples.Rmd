...
knitr::kable(data.frame("Acceptance Rate"=ExampleFC_X1_X2$acc_rate,"Acceptance Rate Post Burnin"=ExampleFC_X1_X2$acc_rate_pos_burnin, "ESS"=effectiveSize(ExampleFC_X1_X2$thinned_chain),"Length"=length(ExampleFC_X1_X2$thinned_chain), "Precision"=ExampleFC_X1_X2$precision), caption = "Monitoreo convergencia cadena para distribución condicional ", col.names = c("Acceptance", "AcceptanceBurn", "ESS", "Length", "Precision"),digits = ) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  column_spec(1:5, bold = TRUE, border_left = TRUE, border_right = TRUE) %>%
