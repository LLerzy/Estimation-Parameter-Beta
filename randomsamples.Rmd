...
El ejemplo de simulación de una muestra de tamaño N=10000 (thin=100) with given values of a, b, c, d and variance (s) es generada a continuación, Plot of Histogram and density, trace, convergence control using averaging and autocorrelation function.
...
La tasa de aceptación, tamaño de muestra efectiva y longitud de la cadena generada en ExampleFC_X1_X2 fue:
